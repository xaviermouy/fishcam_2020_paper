...
This is the repository for the original FishCam paper published in 2020. Since then, both the hardware and software have evolved. To see the latest software updates, please use the repository: https://github.com/xaviermouy/FishCam
